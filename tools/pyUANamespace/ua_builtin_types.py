...
class opcua_value_t():
  ...
  def printOpen62541CCode(self, bootstrapping = True):
    ...
    variantName = ""
    if(bootstrapping):
      variantName = "(*(" + self.parent.getCodePrintableID() + "_variant))"
    else:
    ...
    if self.parent.valueRank() != -1 and (self.parent.valueRank() >=0 or (len(self.value) > 1 and (self.parent.valueRank() != -2 or self.parent.valueRank() != -3))):
      ...
      if self.value[0].__binTypeId__ == BUILTINTYPE_TYPEID_GUID:
        ...
        #code.append(variantName + ".type = &UA_TYPES[UA_TYPES_" + self.value[0].stringRepresentation.upper() + "];")
        ...
        code.append("UA_Variant_setArray( &" + variantName + ", &" + valueName +
      ...
      if self.value[0].__binTypeId__ == BUILTINTYPE_TYPEID_GUID:
        ...
        if self.value[0].__binTypeId__ == BUILTINTYPE_TYPEID_EXTENSIONOBJECT:
          ...
          code.append("UA_Variant_setScalar( &" + variantName + ", " + valueName + ", &UA_TYPES[UA_TYPES_" + self.value[0].stringRepresentation.upper() + "]);")
